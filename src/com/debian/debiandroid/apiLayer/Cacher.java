...
public class Cacher extends StorageUtils{
	...
	public static long cacheLimit = 172800000 ; //48 hours in ms
	 ...
	 * if the cached file doesn't exist
	 * then null is returned. Otherwise it returns the string.
	 * @param fileName the name of the cached file to retrieve
	 * @return the cached string if it exists and if it's fresher than 
	 * the cacheLimit time, otherwise null
	 */
